...
class InputWidget extends StatefulWidget {
  static const routeName = 'InputWidget';
...
class _InputWidgetState extends State<InputWidget> {
  ...
  void didChangeDependencies() {
    if (_istrue) {
      ...
      if (movieId != null) {
        _editmovie = Provider.of<MovieFunctionClass>(context, listen: false)
            .getByid(movieId);
    ...
    try {
      if (movieId == null) {
        await Provider.of<MovieFunctionClass>(context, listen: false)
            ...
            .then(
              (value) => Provider.of<MovieFunctionClass>(context, listen: false)
                  .search(''),
            )
            .then((value) async {
          await Provider.of<DeviceTokens>(context, listen: false)
              .sendNotification('New Movie added', _newMovie.movieName);
        });
      } else {
        await Provider.of<MovieFunctionClass>(context, listen: false)
