...
class CommingSoonDetailsScreen extends StatefulWidget {
  static const routeName = 'CommingSoonDetailsScreen';
  const CommingSoonDetailsScreen({super.key});

  @override
  State<CommingSoonDetailsScreen> createState() =>
      _CommingSoonDetailsScreenState();
}

class _CommingSoonDetailsScreenState extends State<CommingSoonDetailsScreen> {
                ...
                IconButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed(
                        InputCommingSoonScreen.routeName,
                        arguments: _movieId);
                  },
                              ...
                              TextButton(
                                onPressed: () async {
                                  await Provider.of<CommingSoonModelFunction>(
                                          context,
                                          listen: false)
                                      .deleteCommingSoon(_movieId)
                                      .then(
                                        (value) =>
                                            Provider.of<MovieFunctionClass>(
                                                    context,
                                                    listen: false)
                                                .search(''),
                                      )
