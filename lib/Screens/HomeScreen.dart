...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    Provider.of<MovieFunctionClass>(context, listen: false).FetchData().then(
      (_) {
        setState(
          () {
            _isloading = false;
      ...
      Provider.of<MovieFunctionClass>(context, listen: false).search('');
    }).catchError(
      (error) {
        showDialog(
          context: context,
  ...
  Widget build(BuildContext context) {
    final _movieOBJECT = Provider.of<MovieFunctionClass>(context, listen: true);
      ...
      appBar: AppBar(
        ...
        actions: [
          if (FirebaseAuth.instance.currentUser!.uid ==
            ...
            IconButton(
              onPressed: () {
                Navigator.of(context).pushNamed(InputWidget.routeName);
              },
