...
import '../Widgets/GridviewWidgetAnime.dart';
...
class _AnimeScreenState extends State<AnimeScreen> {
  ...
  void initState() {
    ...
    Provider.of<AnimeFunctionClass>(context, listen: false).FetchData().then(
      (_) {
        setState(
          () {
            _isloading = false;
      ...
      Provider.of<AnimeFunctionClass>(context, listen: false).search('');
    }).catchError(
      (error) {
        showDialog(
          context: context,
    ...
    _controller.addListener(() {
      Future.delayed(Duration.zero, () {
        Provider.of<AnimeFunctionClass>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    final _movieOBJECT = Provider.of<AnimeFunctionClass>(context, listen: true);
      ...
      appBar: AppBar(
        ...
        actions: [
          if (FirebaseAuth.instance.currentUser!.uid ==
            ...
            IconButton(
              onPressed: () {
                Navigator.of(context).pushNamed(AnimeINPUT.routeName);
              },
